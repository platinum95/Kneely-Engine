...
void setupShaders() {
	...
	hash_add_item("sphere_shader_position", 0);
	hash_add_item("sphere_shader_normal", 1);
	hash_add_item("sphere_shader_timeDiff", sphereShader.uniformTable[0]->uniformLocation);
	hash_add_item("sphere_shader_waveForm", sphereShader.uniformTable[1]->uniformLocation);
	hash_add_item("sphere_shader_alpha", sphereShader.uniformTable[2]->uniformLocation);
	hash_add_item("sphere_shader_clippy", sphereShader.uniformTable[3]->uniformLocation);
...
void setupEntities() {
	...
	sphere->uniforms.push_back(uniformData(hash_getID("sphere_shader_timeDiff"),
			timeDiff, &BoilerPlate::Shaders::Shader::loadFloatArray));
	sphere->uniforms.push_back(uniformData(hash_getID("sphere_shader_alpha"),
			&waveAlpha, &BoilerPlate::Shaders::Shader::loadFloat2));
	sphere->uniforms.push_back(uniformData(hash_getID("sphere_shader_clippy"),
